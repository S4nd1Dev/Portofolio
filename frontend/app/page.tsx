...
// Penyelamat Error: Komponen SVG Github Kustom
  ...
  return (
    <main className="min-h-screen bg-[#09090b] text-slate-200 p-6 md:p-8 font-sans selection:bg-cyan-500/30 overflow-x-hidden relative">
      ...
      <div className="max-w-[1400px] mx-auto space-y-6">
        ...
        {/* Bento Grid Layout - 12 Columns System */}
        <motion.div 
        ...
        >
          ...
          {/* Card 2: Featured Project - SisaBisa (Spans 4 cols) */}
          <motion.div variants={itemVariants} className="xl:col-span-4 rounded-3xl bg-zinc-900/40 border border-white/5 p-6 flex flex-col group hover:border-emerald-500/30 transition-all duration-300">
          ...
          {/* Card 3: Tech Stack (Spans 3 cols) */}
          ...
          {/* Card 4: Web Desa Project (Spans 4 cols) */}
          ...
          {/* Card 5: Cybersecurity (Spans 4 cols) */}
          ...
          {/* Card 6: Experience & Skills Stack (Spans 4 cols) */}
